...
{    
    ...
    {        
            ...
            $parameter = array(
                        ...
                        "notify_url"	=> SITE_URL.U('Seller/Domain/notifyUrl',array('pay_code'=>'alipay')) , //服务器异步通知页面路径 //必填，不能修改
                        "return_url"	=> SITE_URL.U('Seller/Domain/returnUrl',array('pay_code'=>'alipay')),  //页面跳转同步通知页面路径
                        "out_trade_no"	=> $order['order_sn'], //商户订单号                        
                        "subject"	=> '购买域名', //订单名称 可以中文
